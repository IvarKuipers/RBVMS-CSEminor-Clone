...
int main(int argc, char *argv[])
{
   ...
   j_bicgstab.iterative_mode = false;  
   j_bicgstab.SetRelTol(GMRES_RelTol);  
   j_bicgstab.SetAbsTol(1e-12);         
   j_bicgstab.SetMaxIter(GMRES_MaxIter); 
   j_bicgstab.SetPrintLevel(-1);        
   j_bicgstab.SetMonitor(j_monitor);    
   j_bicgstab.SetPreconditioner(jac_prec); 
